...
for ggi = 1:2
    ...
    hold on
    swarmchart(xAXes1  ,baselineV,20,[0 0.4470 0.7410],'filled','XJitterWidth',0.2)
    boxchart(xAXes1 , baselineV,'BoxFaceColor',[0 0.4470 0.7410],'MarkerStyle','none')

    xAXes2 = ones(numel(trials_E1),1)*2;
    swarmchart(xAXes2,trials_E1,20,[0.8500 0.3250 0.0980],'filled','XJitterWidth',0.2)
    boxchart(xAXes2 , trials_E1,'BoxFaceColor',[0.8500 0.3250 0.0980],'MarkerStyle','none')

    xAXes3 = ones(numel(trials_E2),1)*3;
    swarmchart(xAXes3,trials_E2,20,[0.9290 0.6940 0.1250],'filled','XJitterWidth',0.2)
    boxchart(xAXes3 , trials_E2,'BoxFaceColor',[0.9290 0.6940 0.1250],'MarkerStyle','none')
    hold off
